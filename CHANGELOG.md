...
- Regenerated the extension marketplace icon as a clean 128x128 PNG.
- Kept the extension manifest icon path on `media/icon.png`, matching VS Code publishing requirements.
- Decoupled local CLI installation from the standard compile step so VSIX packaging does not write to `~/.zhihupost`.
- Bumped package metadata to `0.3.2`.

## [0.3.1] - 2026-05-04

### Added

- Added extension icon (知乎蓝 "知" 字)
